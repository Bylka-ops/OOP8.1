...
namespace ConsoleApp13
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            specialist.EndOfCareer += (object sender, EventArgs eventArgs) => Console.WriteLine($"\nКонец карьеры, {specialist.GetLastName()} {specialist.GetFirstName()}");
            specialist.SportsCareer();
